      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center shadow-lg">
                <Library className="w-8 h-8 text-brand-neon" />
              </div>
              <div>
                ...
                <p className="text-brand-mist/90 text-lg">
                  Access key materials for your academic journey
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="p-6 flex-grow flex flex-col">
                <div className="flex items-start justify-between mb-5">
                  <div className="w-12 h-12 rounded-xl bg-brand-mist flex items-center justify-center group-hover:bg-brand-neon/10 transition-colors border border-brand-slate/5">
                    <resource.icon className="w-6 h-6 text-brand-ink group-hover:text-brand-darkgreen transition-colors" />
                  </div>
                ...
                <div className="space-y-3 mb-6 bg-brand-mist p-4 rounded-xl border border-brand-slate/5">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold text-brand-ink">{resource.averageTime}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-brand-slate font-medium flex items-center">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold text-brand-ink">{resource.salary}</span>
                  </div>
                </div>
                ...
                <div className="mb-5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {resource.careers.slice(0, 3).map((career, index) => (
                      <span
                        key={index}
        ...
        {filteredResources.length === 0 && (
          <div className="text-center py-16 bg-white rounded-3xl border border-brand-slate/10 shadow-sm">
            <BookOpen className="h-16 w-16 text-brand-slate opacity-20 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-brand-ink mb-2">
              No resources found
            </h3>
